...
This is a cloaking device console object. It provides player commands to enable/disable ship cloaking by adjusting the ship visibility multiplier, and it supports setting/changing an access passkey.
