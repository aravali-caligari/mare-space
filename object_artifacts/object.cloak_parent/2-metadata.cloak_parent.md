...
This is the cloaking device console object. It provides `$` commands to turn the cloak on/off and to set/change the cloaking passkey, gated by an engineering/management lock. It also provides an in-game help command describing usage and warning about power drain.
