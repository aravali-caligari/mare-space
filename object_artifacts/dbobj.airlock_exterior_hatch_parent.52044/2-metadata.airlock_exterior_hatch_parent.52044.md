...
Airlock Exterior Hatch Parent - Exterior airlock hatch console/parent

## Purpose

This object implements the exterior airlock hatch “exit to space” interaction. It either blocks egress when the airlock is sealed (and notifies the ship/helm), or cycles the player out through the hatch and optionally initializes the player’s space-state for EVA.
