...
Frontier Storm Door Master - Master controller for storm/shipboard sliding doors

## Purpose

This object is a door “master” (parent/controller) responsible for handling door panel interactions, door open/close state, locking/unlocking behavior, and coordinated access control across a set of related doors (via XORList and child scanning). It also supports auto-open/auto-close behavior and a “look through” interaction when the door is open or has a window.
