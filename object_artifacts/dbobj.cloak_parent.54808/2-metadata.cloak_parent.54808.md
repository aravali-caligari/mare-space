...
This object provides shipboard cloaking controls: turning the cloak on/off, setting the initial passkey, changing the passkey, and printing usage/help text. It also emits feedback to the local ship when cloak state changes.
