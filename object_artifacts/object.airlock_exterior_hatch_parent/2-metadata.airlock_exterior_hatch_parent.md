...
Airlock Exterior Hatch Parent - Exterior Airlock Hatch Console

## Purpose

This is the exterior airlock hatch interaction object for a ship. It describes the hatch and controls whether a player can cycle out through it into space or is blocked when the airlock is sealed. When egress is allowed, it triggers ejection logic and (if appropriate) initializes suit/ship-space state for the exiting player.
