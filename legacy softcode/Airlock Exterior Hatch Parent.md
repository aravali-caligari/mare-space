...
Airlock Exterior Hatch Parent - Exterior Airlock Hatch Door

## Purpose

This is the Airlock Exterior Hatch Parent object, used in older versions of the game to provide exterior airlock hatch functionalities for spacecraft. It allows players to safely exit the spacecraft into space by using the exterior airlock hatch, ensuring proper procedures are followed to maintain the integrity of the ship's atmosphere.
